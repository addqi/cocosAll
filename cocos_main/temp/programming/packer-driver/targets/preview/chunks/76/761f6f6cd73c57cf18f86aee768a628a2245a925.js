System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Label, Node, ProgressBar, clientEvent, BattleManager, CardManager, Card, FightManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, GamePanel;
  ...
  function _reportPossibleCrUseOfFightManager(extras) {
    _reporterNs.report("FightManager", "../manager/FightManager", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      FightManager = _unresolved_6.FightManager;
    }],
    execute: function () {
      _crd = true;
      ...
      __checkObsolete__(['_decorator', 'Camera', 'Component', 'EventTouch', 'instantiate', 'Label', 'Node', 'ProgressBar', 'toDegree']);
      ...
      _export("GamePanel", GamePanel = (_dec = ccclass('GamePanel'), _dec2 = property(Label), _dec3 = property(ProgressBar), _dec4 = property(Label), _dec5 = property(ProgressBar), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class GamePanel extends Component {
        ...
        _onTouchStart(event) {
          if ((_crd && CardManager === void 0 ? (_reportPossibleCrUseOfCardManager({
            ...
            (_crd && FightManager === void 0 ? (_reportPossibleCrUseOfFightManager({
              error: Error()
            }), FightManager) : FightManager).instance.touchStart(event);
          }
        }
        ...
        _onTouchMove(event) {
          if ((_crd && CardManager === void 0 ? (_reportPossibleCrUseOfCardManager({
            ...
            (_crd && FightManager === void 0 ? (_reportPossibleCrUseOfFightManager({
              error: Error()
            }), FightManager) : FightManager).instance.touchMove(event);
          }
        }
        ...
        _onTouchEnd(event) {
          if ((_crd && CardManager === void 0 ? (_reportPossibleCrUseOfCardManager({
            ...
            (_crd && FightManager === void 0 ? (_reportPossibleCrUseOfFightManager({
              error: Error()
            }), FightManager) : FightManager).instance.touchEnd(event);
          }
        }
        ...
        _onTouchCancel(event) {
          if ((_crd && CardManager === void 0 ? (_reportPossibleCrUseOfCardManager({
            ...
            (_crd && FightManager === void 0 ? (_reportPossibleCrUseOfFightManager({
              error: Error()
            }), FightManager) : FightManager).instance.touchCancel(event);
          }
        } //初始化卡牌


        initCardInfo() {
          var cardInfo = (_crd && CardManager === void 0 ? (_reportPossibleCrUseOfCardManager({
            error: Error()
        ...
        updateCard() {
          var cardArry = (_crd && CardManager === void 0 ? (_reportPossibleCrUseOfCardManager({
            error: Error()
          }), CardManager) : CardManager).instance.cardArry;

          for (var i = 0; i < this.cardNodeList.length; i++) {
            var card = this.cardNodeList[i];
            var cardinfo = cardArry[i];
          ...
          this.cardList.children.forEach(node => {
            var card = node.getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
              error: Error()
            }), Card) : Card); // card.isChoose = false;
        ...
        updateEnemyInfo() {
          var enemyBattleInfo = (_crd && BattleManager === void 0 ? (_reportPossibleCrUseOfBattleManager({
            error: Error()
          }), BattleManager) : BattleManager).instance.enemyBattleInfo;
          var curreentHp = enemyBattleInfo.curreentHp;
          var maxHp = enemyBattleInfo.hp;
          this.txtDfHp.string = enemyBattleInfo.hp.toString();
          this.dfHpPro.progress = curreentHp / maxHp;
        }

        updateRoleinfo() {
          var battleInfo = (_crd && BattleManager === void 0 ? (_reportPossibleCrUseOfBattleManager({
            error: Error()
          }), BattleManager) : BattleManager).instance.battleInfo;
          var curreentHp = battleInfo.curreentHp;
          var maxHp = battleInfo.hp;
          this.txtMyHp.string = curreentHp.toString();
          var por = curreentHp / maxHp;
        ...
        initCardView() {
          ...
          var maxCount = (_crd && CardManager === void 0 ? (_reportPossibleCrUseOfCardManager({
            error: Error()
          }), CardManager) : CardManager).maxCardCount;

          for (var i = 0; i < maxCount; i++) {
            var node = instantiate(this.card);
            var card = node.getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
              error: Error()
            }), Card) : Card);
            card.init();
...
//# sourceMappingURL=761f6f6cd73c57cf18f86aee768a628a2245a925.js.map