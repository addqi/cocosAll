System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CameraComponent, Component, instantiate, Node, Prefab, resources, clientEvent, BattleManager, FigthManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, GameManager;
  ...
  function _reportPossibleCrUseOfFigthManager(extras) {
    _reporterNs.report("FigthManager", "./FigthManager", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      FigthManager = _unresolved_4.FigthManager;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "eb140oE11tMtK2bzpSbjUne", "GameManager", undefined);

      __checkObsolete__(['_decorator', 'Camera', 'CameraComponent', 'Component', 'EventMouse', 'EventTouch', 'instantiate', 'Node', 'Prefab', 'resources', 'Touch']);
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(CameraComponent), _dec5 = property(Node), _dec(_class = (_class2 = class GameManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        onEnable() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            error: Error()
          }), clientEvent) : clientEvent).on("CreaterPlayer", this.onCreatorPalyer, this);
        }

        onDisable() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            error: Error()
          }), clientEvent) : clientEvent).off("CreaterPlayer", this.onCreatorPalyer, this);
        }
        ...
        init_game() {
          (_crd && FigthManager === void 0 ? (_reportPossibleCrUseOfFigthManager({
            error: Error()
          }), FigthManager) : FigthManager).instance.mainCamer = this.mainCamera;
          (_crd && FigthManager === void 0 ? (_reportPossibleCrUseOfFigthManager({
            error: Error()
          }), FigthManager) : FigthManager).instance.soliderParent = this.soliderNode;
        }
...
//# sourceMappingURL=d5a59fdaa9f358bcba317d445d7307b6bfc42d95.js.map